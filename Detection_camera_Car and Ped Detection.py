...
#This is the camera version code.
#We filmed with a pi-Camera
#The code is almost the same as [Car and Ped Detection.py]
#You only need to set the area, line, and area size little by little.
#I hope it helps
#
#
#
...
out = cv2.VideoWriter('video/real.mp4', fourcc, 30.0, (int(width), int(height)))
"""
...
#car point init
point1 = np.array([[350,260],[415,260],[415,335],[333,335]], np.int32)

#else car point init
point2 = np.array([[250,235],[355,235],[327, 335],[170,335]], np.int32)
...
#	car1 = cv2.rectangle(car1, (0, 0), (91 - 1, 105 - 1), (0, 255, 255))
    ...
    #Car1 frame init
    car1 = frame.copy
    car1 = frame[230:230+130, 140:360]
    ...
    if ret == True:
        ...
        for cnt in countours0:
            ...
            if (area>600 and area < 2500):
                ...
                # car section
                if cx in range(140, 350):
                    if cy in range(200, 340):
                        print(area)
                        ...
                        for i in objs:
                             if abs(x - i.getX()) <= w and abs(y - i.getY()) <= h:
                                ...
                                elif i.going_CAR_OUT(line_in, line_out)==True:                                              cnt_out+=1
        ...
        #cv2.putText(frame, str_bus , (10, 170), font, 0.5, (255,255,0) , 2, cv2.LINE_AA)
